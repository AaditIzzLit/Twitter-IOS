...
//    func userProfile(url: String, success: @escaping ([String : Any]) -> (), failure: @escaping (Error) -> ()){
...
//    func getUserDetails(success: @escaping ([String:Any]) -> (), failure: @escaping (Error) -> ()){
...
//    }
//
//    func getImage(tweetId : String, success: @escaping ([String:Any]) -> (), failure: @escaping (Error) -> ()){
//        let url = "https://api.twitter.com/1.1/users/show.json?screen_name=" + tweetId
//        TwitterAPICaller.client?.get(url, parameters : tweetId, progress: nil, success: { (task: URLSessionDataTask, response: Any?) in
//            success(response as! [String:Any])
//        }, failure: { (task: URLSessionDataTask?, error: Error) in
//            failure(error)
//        })
